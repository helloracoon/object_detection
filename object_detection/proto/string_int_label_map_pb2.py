...
_STRINGINTLABELMAPITEM_KEYPOINTMAP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="StringIntLabelMapItem.KeypointMap.id",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="label",
            full_name="StringIntLabelMapItem.KeypointMap.label",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_STRINGINTLABELMAPITEM = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="keypoints",
            full_name="StringIntLabelMapItem.keypoints",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="ancestor_ids",
            full_name="StringIntLabelMapItem.ancestor_ids",
            index=4,
            number=5,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="descendant_ids",
            full_name="StringIntLabelMapItem.descendant_ids",
            index=5,
            number=6,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="frequency",
            full_name="StringIntLabelMapItem.frequency",
            index=6,
            number=7,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="instance_count",
            full_name="StringIntLabelMapItem.instance_count",
            index=7,
            number=8,
            type=5,
            cpp_type=1,
